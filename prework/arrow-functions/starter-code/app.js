...
// TODO: Uncomment the following line of code to see the output in the browser console
///do Sumation to arrow function
let sumArr=(a, b, c, d)=>a+ b+ c+ d
console.log(sumArr(1, 2, 3, 4),'Arrow result');
...
console.log(objectLitArr(),'objectLitArr Result');
...
let sumAndProductArr =(a, b) =>{
  let sum = a + b;
  let product = a * b;
  return [sum, product];
};
console.log(sumAndProductArr(3, 9),'sumAndProductArr Result');
// TODO: Uncomment the following line of code to see the output in the browser console
// console.log(sumAndProduct(3, 9));
...
console.log(messageArr('Allie'),'messageArr Result');
// TODO: Uncomment the following line of code to see the output in the browser console
// console.log(message('Allie'));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scope(),'joy scope Result');
...
//refere to student object
// 2. What is "this" when joe.scopeArrow() is invoked?
//refere to window(global)
// 3. Explain why "this" is different when an arrow function is used.
//arrow function do not have their own this ,always bound to the value in the closesr non-arrow parent function
